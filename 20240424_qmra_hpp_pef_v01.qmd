...
mu_mean_tp <- (median_tp_children * servings_children) + (median_tp_adults * servings_adults)
mu_mean_hpp <- (median_hpp_children * servings_children) + (median_hpp_adults * servings_adults)
mu_mean_pef <- (median_pef_children * servings_children) + (median_pef_adults * servings_adults)
